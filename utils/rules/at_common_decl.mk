...
CNN_LIB = $(TILER_CNN_KERNEL_PATH)/SSD_BasicKernels.c $(TILER_BILINEAR_RESIZE_KERNEL_PATH)/ResizeBasicKernels.c $(TILER_CNN_KERNEL_PATH)/CNN_Copy.c $(TILER_CNN_KERNEL_PATH_SQ8)/CNN_AT_Misc.c $(TILER_DSP_KERNEL_PATH)/math_funcs.c $(TILER_DSP_KERNEL_PATH)/pulp_dsp/plp_cos_f32s_xpulpv2.c $(TILER_DSP_KERNEL_PATH)/pulp_dsp/plp_sin_f32s_xpulpv2.c $(TILER_DSP_KERNEL_PATH)/pulp_dsp/plp_common_tables.c
