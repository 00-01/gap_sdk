...
static void KerReductIO_Compact_fp(char *__restrict__ To, char *__restrict__ From, int Size, int TotalSize)
...

{
	...
	*/
	...
	KerReductIO_Compact_fp((signed char *__restrict__)In, (signed char *__restrict__)In, ChunkCell, S);
}
