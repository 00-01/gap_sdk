...
def conv_pool_relu_kernels_generator_fp16(gen, node, qrec, in_eparams, out_eparams, cname) -> bool:
...
def gen_cnn_conv_pool_act_fp16(code_block, cname,
    ...
    del at_ver
    code_block.write('CNN_ConvolutionPoolAct_fp16("{}", {}, {}, {}, {}, {},',
                     cname,
                     gen_ctrl,
                     in_feat,
                     out_feat,
...
def gen_cnn_grp_conv_pool_act_fp16(code_block, cname,
                                  grp_in, grp_out, in_feat, out_feat, width, height, bias_size,
                                  conv_oper, fcx, fcy, dcx, dcy, scx, scy, conv_pad,
                                  pool_oper, fpx, fpy, dpx, dpy, spx, spy, pool_pad,
                                  act_oper, gen_ctrl, at_ver=3):
    del at_ver
    code_block.write('CNN_GroupedConvolutionPoolAct_fp16("{}", {}, {}, {}, {}, {}, {}, {},',
                     cname,
                     gen_ctrl,
                     grp_in,
                     grp_out,
...
@kernel_sources(
    '$(TILER_CNN_KERNEL_PATH_FP16)/CNN_Conv_BasicKernels_fp16.c',
    '$(TILER_CNN_KERNEL_PATH_FP16)/CNN_Pooling_BasicKernels_fp16.c',
    '$(TILER_CNN_KERNEL_PATH_FP16)/CNN_Conv_DW_BasicKernels_fp16.c')
