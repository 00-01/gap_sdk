...
PMSIS_IMPLEM_CHIP_SRCS       := $(foreach f, $(PMSIS_IMPLEM_CHIP_SRCS), $(PMSIS_IMPLEM_DIR)/$f)
PMSIS_IMPLEM_CHIP_ASM_SRCS    = $(foreach f, $(PMSIS_IMPLEM_CHIP_ASM_SRC), $(PMSIS_IMPLEM_DIR)/$f)

PMSIS_IMPLEM_CHIP_INC    = $(PMSIS_IMPLEM_DIR) \
                           $(PMSIS_IMPLEM_DIR)/include \
                           $(PMSIS_IMPLEM_DIR)/include/cores/TARGET_RISCV_32 \
                           $(PMSIS_IMPLEM_DIR)/include/pmsis/implem \
                           $(PMSIS_IMPLEM_DIR)/include/pmsis/targets
